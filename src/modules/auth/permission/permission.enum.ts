...
export const Permission = {
  ...
  CREATE_ORDER_PAYMENT_TRANSACTION:
    permissions.CREATE_ORDER_PAYMENT_TRANSACTION.name,
  CREATE_ORDER_REFUND_TRANSACTION:
    permissions.CREATE_ORDER_REFUND_TRANSACTION.name,
  CREATE_ORDER_ITEM_PAYMENT_TRANSACTION:
    permissions.CREATE_ORDER_ITEM_PAYMENT_TRANSACTION.name,
  CREATE_ORDER_ITEM_REFUND_TRANSACTION:
    permissions.CREATE_ORDER_PAYMENT_TRANSACTION.name,
};
